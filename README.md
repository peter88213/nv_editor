...
[Download the latest release (version 2.0.0)](https://github.com/peter88213/nv_editor/raw/main/dist/nv_editor_v2.0.0.zip)

- Extract the "nv_editor_v2.0.0" folder from the downloaded zipfile "nv_editor_v2.0.0.zip".
