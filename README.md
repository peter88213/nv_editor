[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_editor/raw/main/dist/nv_editor_v5.7.1.pyz)
...
Download the latest release [nv_editor_v5.7.1.pyz](https://github.com/peter88213/nv_editor/raw/main/dist/nv_editor_v5.7.1.pyz)

- Launch *nv_editor_v5.7.1.pyz* by double-clicking (Windows desktop),
- or execute `python nv_editor_v5.7.1.pyz` (Windows), resp. `python3 nv_editor_v5.7.1.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_editor_v5.7.1.zip](https://github.com/peter88213/nv_editor/raw/main/dist/nv_editor_v5.7.1.zip)

- Extract the *nv_editor_v5.7.1* folder from the downloaded zipfile "nv_editor_v5.7.1.zip".
